...
<div>
<form action="aarea_search.php" method="get"><br/><br/>

<b>Search for the area here: </b><input type="text" name="value" placeholder="Search here" style="width:150px;height:35px;font:bold 15px Times New Roman;">&nbsp &nbsp
...
$query=mysql_query("select * from area where areaid like '$search_value%'") or die (mysql_error());
