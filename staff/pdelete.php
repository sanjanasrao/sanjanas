...
while ($row = mysql_fetch_array($sqldata)) {
    ...
    <tr bgcolor="<?php echo $class; ?>">
        ...
        <td class="button">
            <a href="pupdate.php?id=<?php echo $row['pid']; ?>"><input type="button" name="update" value="Update"></a>
            <a href="pdelete.php?id=<?php echo $row['pid']; ?>"><input type="button" name="delete" value="Delete"></a>
        </td>
    </tr>
<?php $i++; } ?>
</table>
<a href="pupdatedelete.php"><h1>click here to goback</h1></a> 
</body>