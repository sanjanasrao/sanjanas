...
<div>
<form action="family_search.php" method="get"><br/><br/>

<b>Search for the family here: </b><input type="text" name="value" placeholder="Search here" style="width:150px;height:35px;font:bold 15px Times New Roman;">&nbsp &nbsp
...
$query="select * from family where home_id like '$search_value%'";
?>
